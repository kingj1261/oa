...
//    @Test
    ...
    public void after()throws Exception{
        jdbcTemplate.update("delete os from oa_supervise os where exists(select 1 from oa_message om where om.customer_id=? and om.customer_name=? and om.id=os.message_id)","99999","sharpe");

        jdbcTemplate.update("delete ore from oa_remind ore where exists(select 1 from oa_message om where om.customer_id=? and om.customer_name=? and om.id=ore.message_id)","99999","sharpe");

        jdbcTemplate.update("delete om from oa_message om where om.customer_id=? and om.customer_name=?","99999","sharpe");
