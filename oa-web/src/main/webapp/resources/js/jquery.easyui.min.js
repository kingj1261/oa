...
if(bb.length){
var bc=$("<span class=\"textbox-addon\" style=\"border-left:1px solid #c2c2c2;\"></span>").prependTo(tb);
...
if(opts.maxLength) _4c4.attr("maxLength",opts.maxLength);//edit by lihai
_4c4.unbind(".textbox");
if(!opts.disabled&&!opts.readonly){
...
var dc=_5d4.dc;
var wrap=_5d4.panel;
var _5d5=wrap.width();// +20覆盖最右侧的滚动空白列，如需要，可去掉+20，肖红斌 改
...
if(typeof opts.showAll =="string"){
	var wholeRow={};
	wholeRow[opts.valueField]="";
	wholeRow[opts.textField]=opts.showAll;
	data.unshift(wholeRow);
}else if(typeof opts.showAll == "boolean"){
	var wholeRow={};
	wholeRow[opts.valueField]="";
	wholeRow[opts.textField]="全部";
	data.unshift(wholeRow);
}
_9ca(data);
},error:function(){
