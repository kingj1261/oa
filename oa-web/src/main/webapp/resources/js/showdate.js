...
'#Tools {width:204px;background:#f6f6f6;padding:0px;}'+
'#Tools li{padding-bottom:1px;}'+
'#Tools a{color:#000;border:1px solid;margin:0;padding:0}'+
'#Tools a:hover{border:1px solid #09fae9;background:#58CFF5;}'+
'#Title {width:204px;background:#f6f6f6;}'+
'#Title li{height:16px;padding-top:3px;}'+
'#sYear,#sMonth {width:44px;height:16px;border:1px solid  #88A9C9;border-right:0;padding-top:2px;margin:0;}'+
...
'#Select a:hover{color:#000;background:#E2EBF4;padding-top:2px;}'+
'#Select #SelectBn {background:#0AB1FF;font-size:8px;line-height:7px;height:7px;text-align:center;color:#44b6ae;}'+
...
'ipt><div style="border:1px solid #d6d6d6;height:'+(64+21*Trn)+'px;"><ul><li style="background:#FFF;"></li>'+
