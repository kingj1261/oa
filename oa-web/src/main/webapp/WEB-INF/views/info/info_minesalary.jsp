...
<script type="text/javascript">
    $(function () {
        ...
        lineChart('#LineData3', 'line');
        pieChart('#pieChart', 'pie');
    });
</script>

<div class="listDataTitle"><i class="listDataTitleImg"></i> <a>您当前位置:</a><a href="">我的绩效</a>&#47;<a
        class="TitleActiveColor">我的工资</a>
</div>
<div class="userBox marginBottom dataToBox">
    ...
    <dl class="listDataClassBox dataToBox fl" style="margin-top: 15px;">
        <dd class="unitBox" style="width: 350px;">
            <em class="DataText FontBold">查询时间:</em>
            <select class="onlyWidth DataText">
        ...
        <dd class="unitBox ">
            <em class="DataText TitleActiveColor"> 2015年9月1日 至 2015年9月30日</em>
        </dd>
...
<div class=" inofListBorder marginBottom">
    ...
    <div class="popupTextCont">
        <div class="listDataTable marginBottom listTextS" style="display: block">
            ...
            <div class="marginBottom" id="LineData1">
...
<div class="chartsBox inofBox">
    <h3 class="marginBottom">一年内实发工资趋势图</h3>
    <div id="LineData"></div>
</div>
