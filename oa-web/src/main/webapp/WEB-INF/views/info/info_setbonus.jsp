...
<title>绩效管理-岗位奖金设置</title>
<script type="text/javascript">
    $(function () {
        var radioImg = $('.radioImg');
        $('#unitBox').css('display', 'none');
        $('.BoxNone').load('/info/dataTable.html #firmBox2');
        radioImg.click(function () {
            if ($(this).text() == '公司通用设置') {
                ...
                $('.BoxNone').load('/info/dataTable.html #personBox2');
            }
        });
    });
</script>
...
<div class="popupBox" id="PromoterBox">
    <div class="popupContBox delBoxPopup">
        <div class="popupTitle"><i class="iconCls"></i><span>提示</span></div>
        <div class="popupTextBox">
            ...
            <ul class="popupBtn">
                <li class="marginBottom count">确 定</li>
