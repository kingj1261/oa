...
<title>我的绩效-我的工资构成</title><link rel="stylesheet" href="${ctx}/resources/css/r_agent.css" type="text/css" />
<div class="listDataTitle"><i class="listDataTitleImg"></i> <a>您当前位置:</a><a href="">我的绩效</a>&#47;<a class="TitleActiveColor">我的工资构成</a>
</div>
<div class="">
    <dl class="listDataClassBox dataToBox borderBlod" style="margin-bottom:6px;">
        <dd class="unitBox">
            <em class="DataText FontBold">部门:</em>
            <em class="DataText disabledColor">产品部</em>
        </dd>
        <dd class="unitBox">
            <em class="DataText FontBold">姓名:</em>
            <em class="DataText disabledColor">李娟</em>
        </dd>
    </dl>
    <dl class="listDataClassBox dataToBox">
        <dd class="unitBox">
            <em class="DataText">实发工资:</em>
    ...
    <div class="inofList">
        <dl class="listDataClassBox ">
            ...
            <dd class="unitBox" style="clear: both;">
                <em class="DataText FontBold formWidth" >工龄工资:</em>
                <span class="disabledColor DataCont">000</span>
                <em class="DataText">&nbsp;&nbsp;元</em>
            </dd>
            <dd class="unitBox">
