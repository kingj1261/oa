...
<head>
    ...
    <link rel="stylesheet" href="editor-app/libs/bootstrap_3.1.1/css/bootstrap.min.css" type="text/css"/>
	...
	<link rel="stylesheet" href="editor-app/css/style-common.css" type="text/css">
    <link rel="stylesheet" href="editor-app/css/style-editor.css" type="text/css">
...
<body>
	...
	<!--[if lt IE 9]>
	<script src="editor-app/libs/es5-shim-15.3.4.5/es5-shim.js" type="text/javascript"></script>
	<script src="editor-app/libs/json3_3.2.6/lib/json3.min.js" type="text/javascript"></script>
	<![endif]-->

	<script src="editor-app/libs/jquery_1.11.0/jquery.min.js" type="text/javascript"></script>
	<script src="editor-app/libs/jquery-ui-1.10.3.custom.min.js" type="text/javascript"></script>

	<script src="editor-app/libs/angular_1.2.13/angular.min.js" type="text/javascript"></script>
	<script src="editor-app/libs/angular_1.2.13/angular-animate.min.js" type="text/javascript"></script>
	<script src="editor-app/libs/bootstrap_3.1.1/js/bootstrap.min.js" type="text/javascript"></script>
	<script src="editor-app/libs/angular-resource_1.2.13/angular-resource.min.js" type="text/javascript"></script>
	<script src="editor-app/libs/angular-cookies_1.2.13/angular-cookies.min.js" type="text/javascript"></script>
	<script src="editor-app/libs/angular-sanitize_1.2.13/angular-sanitize.min.js" type="text/javascript"></script>
	<script src="editor-app/libs/angular-route_1.2.13/angular-route.min.js" type="text/javascript"></script>
	<script src="editor-app/libs/angular-translate_2.4.2/angular-translate.min.js" type="text/javascript"></script>
	<script src="editor-app/libs/angular-translate-storage-cookie/angular-translate-storage-cookie.js" type="text/javascript"></script>
	<script src="editor-app/libs/angular-translate-loader-static-files/angular-translate-loader-static-files.js" type="text/javascript"></script>
	<script src="editor-app/libs/angular-strap_2.0.5/angular-strap.min.js" type="text/javascript"></script>
	<script src="editor-app/libs/angular-strap_2.0.5/angular-strap.tpl.min.js" type="text/javascript"></script>
	<script src="editor-app/libs/momentjs_2.5.1/momentjs.min.js" type="text/javascript"></script>
	...
	<!-- Configuration -->
	<script src="editor-app/app-cfg.js?v=1" type="text/javascript"></script>
	...
	<script src="editor-app/app.js" type="text/javascript"></script>
